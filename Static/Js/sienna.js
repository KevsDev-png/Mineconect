document.addEventListener("DOMContentLoaded", function() {
    const defaultOptions = {
        ...
        buttonIconColor: '#63943b',
        highlightColor: '#ec942a',
    ...
    <style>
        ...
        .asw-menu { display: none; top: 96px; border-radius: 8px; box-shadow: -1px 0 20px -14px #000; opacity: 1; overflow: hidden; background: ${options.menuBackgroundColor}; width: 500px; line-height: 1; font-size: 14px; height: calc(100vh - 40px - 75px); letter-spacing: .015em; color: ${options.menuTextColor}; left: 6%; }
        ...
        .asw-btn { width: 140px; height: 120px; border-radius: 8px; padding: 15px; display: flex; align-items: center; justify-content: center; flex-direction: column; text-align: center; color: #333; background:rgb(255, 255, 255); border: 3px solid #63943b; transition: background-color .3s; cursor: pointer; }
        ...
        .asw-footer { position: absolute; bottom: 0; left: 0; right: 0; background: #63943b; padding: 16px; text-align: center; color: #fff; }
        ...
        .asw-adjust-font div[role=button] { background:rgba(3, 3, 3, 1); border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; color: #fff; cursor: pointer; }
        .asw-overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 10000; display: none; }
        @media only screen and (max-width: 560px) {
            .asw-menu { width: calc(100vw - 40px); left: 20px; }
            .asw-btn { width: calc(50% - 10px); }
        }
    </style>
    <div class="asw-widget">
        <div class="asw-menu-btn" title="Accesibilidad" role="button" aria-expanded="false">
